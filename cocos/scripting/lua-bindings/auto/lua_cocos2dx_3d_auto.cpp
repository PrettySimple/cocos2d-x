...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.Animation3D", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.Animation3D", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.Animate3D", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.Animate3D", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.TextureCube", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.TextureCube", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.AttachNode", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.BillBoard", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.BillBoard", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.Mesh", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.Skeleton3D", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.Skybox", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.Skybox", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.Sprite3D", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.Sprite3D", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.Sprite3DCache", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.Sprite3DCache", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.Bundle3D", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.Bundle3D", 0, &tolua_err))
        goto tolua_lerror;
#endif
