...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "ccexp.TMXLayer", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "ccexp.TMXLayer", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "ccexp.TMXTiledMap", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "ccexp.TMXTiledMap", 0, &tolua_err))
        goto tolua_lerror;
#endif
