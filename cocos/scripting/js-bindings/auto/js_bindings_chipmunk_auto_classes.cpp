...
void JSB_cpConstraint_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("destroy", JSB_cpConstraint_destroy, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JSB_cpConstraint_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpBase_object), JSB_cpConstraint_class, JSB_cpConstraint_constructor, 0,
...
void JSB_cpGrooveJoint_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("getAnchorB", JSB_cpGrooveJoint_getAnchorB, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JSB_cpGrooveJoint_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpConstraint_object), JSB_cpGrooveJoint_class,
                                            JSB_cpGrooveJoint_constructor, 0, properties, funcs, NULL, st_funcs);
}
...
void JSB_cpSimpleMotor_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("getRate", JSB_cpSimpleMotor_getRate, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("setRate", JSB_cpSimpleMotor_setRate, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};
    static JSFunctionSpec st_funcs[] = {JS_FS_END};

    JSB_cpSimpleMotor_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpConstraint_object), JSB_cpSimpleMotor_class,
                                            JSB_cpSimpleMotor_constructor, 0, properties, funcs, NULL, st_funcs);
}
...
void JSB_cpPivotJoint_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("getAnchorA", JSB_cpPivotJoint_getAnchorA, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     ...
                                     JS_FN("setAnchorB", JSB_cpPivotJoint_setAnchorB, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};
    static JSFunctionSpec st_funcs[] = {JS_FS_END};

    JSB_cpPivotJoint_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpConstraint_object), JSB_cpPivotJoint_class, JSB_cpPivotJoint_constructor,
                                           0, properties, funcs, NULL, st_funcs);
}
...
void JSB_cpPinJoint_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("getAnchorA", JSB_cpPinJoint_getAnchorA, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JSB_cpPinJoint_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpConstraint_object), JSB_cpPinJoint_class, JSB_cpPinJoint_constructor, 0,
                                         properties, funcs, NULL, st_funcs);
}
...
void JSB_cpSlideJoint_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("getAnchorA", JSB_cpSlideJoint_getAnchorA, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JSB_cpSlideJoint_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpConstraint_object), JSB_cpSlideJoint_class, JSB_cpSlideJoint_constructor,
                                           0, properties, funcs, NULL, st_funcs);
}
...
void JSB_cpGearJoint_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("getPhase", JSB_cpGearJoint_getPhase, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     ...
                                     JS_FN("setRatio", JSB_cpGearJoint_setRatio, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};
    static JSFunctionSpec st_funcs[] = {JS_FS_END};

    JSB_cpGearJoint_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpConstraint_object), JSB_cpGearJoint_class, JSB_cpGearJoint_constructor, 0,
                                          properties, funcs, NULL, st_funcs);
}
...
void JSB_cpDampedRotarySpring_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("getDamping", JSB_cpDampedRotarySpring_getDamping, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JSB_cpDampedRotarySpring_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpConstraint_object), JSB_cpDampedRotarySpring_class,
                                                   JSB_cpDampedRotarySpring_constructor, 0, properties, funcs, NULL, st_funcs);
}
...
void JSB_cpDampedSpring_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("getAnchorA", JSB_cpDampedSpring_getAnchorA, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JSB_cpDampedSpring_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpConstraint_object), JSB_cpDampedSpring_class,
                                             JSB_cpDampedSpring_constructor, 0, properties, funcs, NULL, st_funcs);
}
...
void JSB_cpRatchetJoint_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("getAngle", JSB_cpRatchetJoint_getAngle, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JSB_cpRatchetJoint_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpConstraint_object), JSB_cpRatchetJoint_class,
                                             JSB_cpRatchetJoint_constructor, 0, properties, funcs, NULL, st_funcs);
}
...
void JSB_cpRotaryLimitJoint_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("getMax", JSB_cpRotaryLimitJoint_getMax, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     ...
                                     JS_FN("setMin", JSB_cpRotaryLimitJoint_setMin, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};
    static JSFunctionSpec st_funcs[] = {JS_FS_END};

    JSB_cpRotaryLimitJoint_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpConstraint_object), JSB_cpRotaryLimitJoint_class,
                                                 JSB_cpRotaryLimitJoint_constructor, 0, properties, funcs, NULL, st_funcs);
}
...
void JSB_cpArbiter_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("callWildcardBeginA", JSB_cpArbiter_callWildcardBeginA, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JSB_cpArbiter_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpBase_object), JSB_cpArbiter_class, JSB_cpArbiter_constructor, 0, properties,
                                        funcs, NULL, st_funcs);
}
...
void JSB_cpSpace_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("containsBody", JSB_cpSpace_containsBody, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JSB_cpSpace_object =
        JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpBase_object), JSB_cpSpace_class, JSB_cpSpace_constructor, 0, properties, funcs, NULL, st_funcs);
}
...
void JSB_cpBody_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("activate", JSB_cpBody_activate, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JSB_cpBody_object =
        JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpBase_object), JSB_cpBody_class, JSB_cpBody_constructor, 0, properties, funcs, NULL, st_funcs);
}
...
void JSB_cpShape_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("cacheBB", JSB_cpShape_cacheBB, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JSB_cpShape_object =
        JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpBase_object), JSB_cpShape_class, JSB_cpShape_constructor, 0, properties, funcs, NULL, st_funcs);
}
...
void JSB_cpCircleShape_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("getOffset", JSB_cpCircleShape_getOffset, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("getRadius", JSB_cpCircleShape_getRadius, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};
    static JSFunctionSpec st_funcs[] = {JS_FS_END};

    JSB_cpCircleShape_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpShape_object), JSB_cpCircleShape_class, JSB_cpCircleShape_constructor, 0,
                                            properties, funcs, NULL, st_funcs);
}
...
void JSB_cpSegmentShape_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("getA", JSB_cpSegmentShape_getA, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JSB_cpSegmentShape_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpShape_object), JSB_cpSegmentShape_class, JSB_cpSegmentShape_constructor,
                                             0, properties, funcs, NULL, st_funcs);
}
...
void JSB_cpPolyShape_createClass(JSContext* cx, JS::HandleObject globalObj, const char* name)
{
    ...
    static JSPropertySpec properties[] = {{0, 0, 0, 0, 0}};
    static JSFunctionSpec funcs[] = {JS_FN("getCount", JSB_cpPolyShape_getCount, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("getRadius", JSB_cpPolyShape_getRadius, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("getVert", JSB_cpPolyShape_getVert, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};
    static JSFunctionSpec st_funcs[] = {JS_FS_END};

    JSB_cpPolyShape_object = JS_InitClass(cx, globalObj, JS::RootedObject(cx, JSB_cpShape_object), JSB_cpPolyShape_class, JSB_cpPolyShape_constructor, 0,
                                          properties, funcs, NULL, st_funcs);
}
