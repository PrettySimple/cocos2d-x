...
void js_register_cocos2dx_3d_extension_ParticleSystem3D(JSContext* cx, JS::HandleObject global)
{
    ...
    jsb_cocos2d_ParticleSystem3D_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_ParticleSystem3D_class,
...
void js_register_cocos2dx_3d_extension_PUParticleSystem3D(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_3d_extension_PUParticleSystem3D_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_ParticleSystem3D_prototype);
    jsb_cocos2d_PUParticleSystem3D_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_PUParticleSystem3D_class,
