...
void js_register_cocos2dx_spine_SkeletonRenderer(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_spine_SkeletonRenderer_createWithFile, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Node_prototype);
    jsb_spine_SkeletonRenderer_prototype = JS_InitClass(cx, global, parent_proto, jsb_spine_SkeletonRenderer_class,
...
void js_register_cocos2dx_spine_SkeletonAnimation(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_spine_SkeletonAnimation_createWithFile, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_spine_SkeletonRenderer_prototype);
    jsb_spine_SkeletonAnimation_prototype = JS_InitClass(cx, global, parent_proto, jsb_spine_SkeletonAnimation_class,
