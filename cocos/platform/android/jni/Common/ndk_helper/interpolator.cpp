...
namespace ndk_helper
{
    ...
    Interpolator& Interpolator::Set(const float start, const float dest, const INTERPOLATOR_TYPE type, const double duration)
    {
    ...
    Interpolator& Interpolator::Add(const float dest, const INTERPOLATOR_TYPE type, const double duration)
    {
    ...
    float Interpolator::GetFormula(const INTERPOLATOR_TYPE type, const float t, const float b, const float d, const float c)
    {
        float t1;
        switch (type)
        {
