...
namespace flatbuffers
{
    ...
    struct CSArmatureNodeOption : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* nodeOptions */) && verifier.VerifyTable(nodeOptions()) &&
                ...
                VerifyField<uint8_t>(verifier, 8 /* isLoop */) && VerifyField<uint8_t>(verifier, 10 /* isAutoPlay */) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 12 /* currentAnimationName */) && verifier.Verify(currentAnimationName()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<CSArmatureNodeOption>
    CreateCSArmatureNodeOption(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> nodeOptions = 0,
                               flatbuffers::Offset<ResourceItemData> fileData = 0, uint8_t isLoop = 1, uint8_t isAutoPlay = 1,
    ...
    struct ResourceItemData : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, 4 /* type */) && VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* path */) &&
    ...
    inline flatbuffers::Offset<ResourceItemData>
    CreateResourceItemData(flatbuffers::FlatBufferBuilder& _fbb, int32_t type = 0, flatbuffers::Offset<flatbuffers::String> path = 0)
    {
