...
namespace flatbuffers
{
    ...
    struct BoneOptions : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* nodeOptions */) && verifier.VerifyTable(nodeOptions()) &&
                VerifyField<float>(verifier, 6 /* length */) && VerifyField<flatbuffers::BlendFunc>(verifier, 8 /* blendFunc */) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<BoneOptions> CreateBoneOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<flatbuffers::WidgetOptions> nodeOptions = 0,
    ...
    struct SkeletonOptions : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* boneOptions */) && verifier.VerifyTable(boneOptions()) &&
                verifier.EndTable();
        }
    };
