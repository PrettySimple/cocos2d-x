...
namespace cocosbuilder
{
    ...
    CCBKeyframe* CCBReader::readKeyframe(PropertyType type)
    {
        ...
        if (easingType == CCBKeyframe::EasingType::CUBIC_IN || easingType == CCBKeyframe::EasingType::CUBIC_OUT ||
            easingType == CCBKeyframe::EasingType::CUBIC_INOUT || easingType == CCBKeyframe::EasingType::ELASTIC_IN ||
