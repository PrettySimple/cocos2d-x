...
{
    asm volatile("vld1.32     {d16 - d19}, [%1]! \n\t" // M1[m0-m7]
                 "vld1.32     {d20 - d23}, [%1]  \n\t" // M1[m8-m15]
                 "vld1.32     {d0 - d3}, [%2]!   \n\t" // M2[m0-m7]
                 "vld1.32     {d4 - d7}, [%2]    \n\t" // M2[m8-m15]
...
{
    asm volatile("vld4.32 {d0[0], d2[0], d4[0], d6[0]}, [%1]!    \n\t" // DST->M[m0, m4, m8, m12] = M[m0-m3]
