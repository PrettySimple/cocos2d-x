...
#    if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.NavMeshAgent", 0, &tolua_err))
        goto tolua_lerror;
#    endif
...
#    if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.NavMeshObstacle", 0, &tolua_err))
        goto tolua_lerror;
#    endif
...
#    if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.NavMeshObstacle", 0, &tolua_err))
        goto tolua_lerror;
#    endif
...
#    if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.NavMesh", 0, &tolua_err))
        goto tolua_lerror;
#    endif
...
#    if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.NavMesh", 0, &tolua_err))
        goto tolua_lerror;
#    endif
