...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.Control", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.Control", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.ControlButton", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.ControlButton", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.ControlHuePicker", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.ControlHuePicker", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.ControlSaturationBrightnessPicker", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
int lua_cocos2dx_extension_ControlSaturationBrightnessPicker_create(lua_State* tolua_S)
{
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.ControlSaturationBrightnessPicker", 0, &tolua_err))
        goto tolua_lerror;
#endif
    ...
    if (argc == 2)
    {
        ...
        object_to_luaval<cocos2d::extension::ControlSaturationBrightnessPicker>(tolua_S, "cc.ControlSaturationBrightnessPicker",
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.ControlColourPicker", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.ControlColourPicker", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.ControlPotentiometer", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
int lua_cocos2dx_extension_ControlPotentiometer_angleInDegreesBetweenLineFromPoint_toPoint_toLineFromPoint_toPoint(lua_State* tolua_S)
{
    ...
    {
        tolua_error(tolua_S,
                    "invalid 'cobj' in function 'lua_cocos2dx_extension_ControlPotentiometer_angleInDegreesBetweenLineFromPoint_toPoint_toLineFromPoint_toPoint'",
                    nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_ControlPotentiometer_angleInDegreesBetweenLineFromPoint_toPoint_toLineFromPoint_toPoint'.",
                &tolua_err);
#endif
...
int lua_cocos2dx_extension_ControlPotentiometer_initWithTrackSprite_ProgressTimer_ThumbSprite(lua_State* tolua_S)
{
    ...
    if (argc == 3)
    {
        ...
        ok &= luaval_to_object<cocos2d::ProgressTimer>(tolua_S, 3, "cc.ProgressTimer", &arg1,
                                                       "cc.ControlPotentiometer:initWithTrackSprite_ProgressTimer_ThumbSprite");
        ...
        if (!ok)
        {
            tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_ControlPotentiometer_initWithTrackSprite_ProgressTimer_ThumbSprite'",
                        nullptr);
            return 0;
        }
...
int lua_cocos2dx_extension_ControlPotentiometer_create(lua_State* tolua_S)
{
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.ControlPotentiometer", 0, &tolua_err))
        goto tolua_lerror;
#endif
    ...
    if (argc == 3)
    {
        ...
        const char* arg2;
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "cc.ControlPotentiometer:create");
        arg0 = arg0_tmp.c_str();
        std::string arg1_tmp;
        ok &= luaval_to_std_string(tolua_S, 3, &arg1_tmp, "cc.ControlPotentiometer:create");
        arg1 = arg1_tmp.c_str();
        std::string arg2_tmp;
        ok &= luaval_to_std_string(tolua_S, 4, &arg2_tmp, "cc.ControlPotentiometer:create");
        arg2 = arg2_tmp.c_str();
        if (!ok)
        {
...
int lua_register_cocos2dx_extension_ControlPotentiometer(lua_State* tolua_S)
{
    ...
    tolua_function(tolua_S, "initWithTrackSprite_ProgressTimer_ThumbSprite",
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.ControlSlider", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
int lua_cocos2dx_extension_ControlSlider_create(lua_State* tolua_S)
{
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.ControlSlider", 0, &tolua_err))
        goto tolua_lerror;
#endif
    ...
    do
    {
        if (argc == 3)
        {
            const char* arg0;
            std::string arg0_tmp;
            ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "cc.ControlSlider:create");
            arg0 = arg0_tmp.c_str();
            if (!ok)
            {
                break;
            ...
            const char* arg1;
            std::string arg1_tmp;
            ok &= luaval_to_std_string(tolua_S, 3, &arg1_tmp, "cc.ControlSlider:create");
            arg1 = arg1_tmp.c_str();
            if (!ok)
            {
                break;
            ...
            const char* arg2;
            std::string arg2_tmp;
            ok &= luaval_to_std_string(tolua_S, 4, &arg2_tmp, "cc.ControlSlider:create");
            arg2 = arg2_tmp.c_str();
            if (!ok)
            {
                break;
    ...
    do
    {
        if (argc == 4)
        {
            ...
            const char* arg3;
            std::string arg3_tmp;
            ok &= luaval_to_std_string(tolua_S, 5, &arg3_tmp, "cc.ControlSlider:create");
            arg3 = arg3_tmp.c_str();
            if (!ok)
            {
                break;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.ControlStepper", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.ControlStepper", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.ControlSwitch", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.ControlSwitch", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.ScrollView", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.ScrollView", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.TableViewCell", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.TableViewCell", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.TableView", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
int lua_cocos2dx_extension_AssetsManager_setStoragePath(lua_State* tolua_S)
{
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.AssetsManager", 0, &tolua_err))
        goto tolua_lerror;
#endif
    ...
    if (argc == 1)
    {
        ...
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "cc.AssetsManager:setStoragePath");
        arg0 = arg0_tmp.c_str();
        if (!ok)
        {
...
int lua_cocos2dx_extension_AssetsManager_setPackageUrl(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "cc.AssetsManager:setPackageUrl");
        arg0 = arg0_tmp.c_str();
        if (!ok)
        {
...
int lua_cocos2dx_extension_AssetsManager_setVersionFileUrl(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "cc.AssetsManager:setVersionFileUrl");
        arg0 = arg0_tmp.c_str();
        if (!ok)
        {
...
int lua_cocos2dx_extension_AssetsManager_create(lua_State* tolua_S)
{
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.AssetsManager", 0, &tolua_err))
        goto tolua_lerror;
#endif
    ...
    if (argc == 6)
    {
        ...
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "cc.AssetsManager:create");
        arg0 = arg0_tmp.c_str();
        std::string arg1_tmp;
        ok &= luaval_to_std_string(tolua_S, 3, &arg1_tmp, "cc.AssetsManager:create");
        arg1 = arg1_tmp.c_str();
        std::string arg2_tmp;
        ok &= luaval_to_std_string(tolua_S, 4, &arg2_tmp, "cc.AssetsManager:create");
        arg2 = arg2_tmp.c_str();
        do
        {
...
int lua_cocos2dx_extension_AssetsManager_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "cc.AssetsManager:AssetsManager");
        arg0 = arg0_tmp.c_str();
        if (!ok)
        {
            tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_AssetsManager_constructor'", nullptr);
    ...
    if (argc == 2)
    {
        ...
        std::string arg1_tmp;
        ok &= luaval_to_std_string(tolua_S, 3, &arg1_tmp, "cc.AssetsManager:AssetsManager");
        arg1 = arg1_tmp.c_str();
        if (!ok)
        {
            tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_AssetsManager_constructor'", nullptr);
    ...
    if (argc == 3)
    {
        ...
        std::string arg2_tmp;
        ok &= luaval_to_std_string(tolua_S, 4, &arg2_tmp, "cc.AssetsManager:AssetsManager");
        arg2 = arg2_tmp.c_str();
        if (!ok)
        {
            tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_AssetsManager_constructor'", nullptr);
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.EventAssetsManagerEx", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.Manifest", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.AssetsManagerEx", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.AssetsManagerEx", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.EventListenerAssetsManagerEx", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S, 1, "cc.PUParticleSystem3D", 0, &tolua_err))
        goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S, 1, "cc.PUParticleSystem3D", 0, &tolua_err))
        goto tolua_lerror;
#endif
