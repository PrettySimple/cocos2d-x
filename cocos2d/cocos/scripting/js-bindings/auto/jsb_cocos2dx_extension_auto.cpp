...
void js_register_cocos2dx_extension_Control(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_extension_Control_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Layer_prototype);
    jsb_cocos2d_extension_Control_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_Control_class,
...
void js_register_cocos2dx_extension_ControlButton(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_extension_ControlButton_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_extension_Control_prototype);
    jsb_cocos2d_extension_ControlButton_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_ControlButton_class,
...
void js_register_cocos2dx_extension_ControlHuePicker(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_extension_ControlHuePicker_create, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_extension_Control_prototype);
    jsb_cocos2d_extension_ControlHuePicker_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_ControlHuePicker_class,
...
void js_register_cocos2dx_extension_ControlSaturationBrightnessPicker(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_extension_ControlSaturationBrightnessPicker_create, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                        JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_extension_Control_prototype);
    jsb_cocos2d_extension_ControlSaturationBrightnessPicker_prototype =
        JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_ControlSaturationBrightnessPicker_class,
...
bool js_cocos2dx_extension_ControlColourPicker_getcolourPicker(JSContext* cx, uint32_t argc, jsval* vp)
{
    ...
    if (argc == 0)
    {
        ...
        if (ret)
        {
            jsret = OBJECT_TO_JSVAL(js_get_or_create_jsobject<cocos2d::extension::ControlSaturationBrightnessPicker>(
                cx, (cocos2d::extension::ControlSaturationBrightnessPicker*)ret));
        }
        else
        {
            jsret = JSVAL_NULL;
...
void js_register_cocos2dx_extension_ControlColourPicker(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_extension_ControlColourPicker_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_extension_Control_prototype);
    jsb_cocos2d_extension_ControlColourPicker_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_ControlColourPicker_class,
...
bool js_cocos2dx_extension_ControlPotentiometer_angleInDegreesBetweenLineFromPoint_toPoint_toLineFromPoint_toPoint(JSContext* cx, uint32_t argc, jsval* vp)
{
    ...
    JSB_PRECONDITION2(cobj, cx, false,
                      "js_cocos2dx_extension_ControlPotentiometer_angleInDegreesBetweenLineFromPoint_toPoint_toLineFromPoint_toPoint : Invalid Native Object");
    if (argc == 4)
    {
        cocos2d::Vec2 arg0;
        cocos2d::Vec2 arg1;
        ...
        JSB_PRECONDITION2(
            ok, cx, false,
            "js_cocos2dx_extension_ControlPotentiometer_angleInDegreesBetweenLineFromPoint_toPoint_toLineFromPoint_toPoint : Error processing arguments");
    ...
    JS_ReportError(
        cx, "js_cocos2dx_extension_ControlPotentiometer_angleInDegreesBetweenLineFromPoint_toPoint_toLineFromPoint_toPoint : wrong number of arguments: %d, was expecting %d",
        argc, 4);
    return false;
}
...
bool js_cocos2dx_extension_ControlPotentiometer_initWithTrackSprite_ProgressTimer_ThumbSprite(JSContext* cx, uint32_t argc, jsval* vp)
{
    ...
    JS_ReportError(cx, "js_cocos2dx_extension_ControlPotentiometer_initWithTrackSprite_ProgressTimer_ThumbSprite : wrong number of arguments: %d, was expecting %d",
                   argc, 3);
    return false;
}
...
bool js_cocos2dx_extension_ControlPotentiometer_create(JSContext* cx, uint32_t argc, jsval* vp)
{
    ...
    if (argc == 3)
    {
        ...
        arg1 = arg1_tmp.c_str();
        std::string arg2_tmp;
        ok &= jsval_to_std_string(cx, args.get(2), &arg2_tmp);
        arg2 = arg2_tmp.c_str();
...
void js_register_cocos2dx_extension_ControlPotentiometer(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {
        ...
        JS_FN("angleInDegreesBetweenLineFromPoint_toPoint_toLineFromPoint_toPoint",
              js_cocos2dx_extension_ControlPotentiometer_angleInDegreesBetweenLineFromPoint_toPoint_toLineFromPoint_toPoint, 4, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        ...
        JS_FN("initWithTrackSprite_ProgressTimer_ThumbSprite", js_cocos2dx_extension_ControlPotentiometer_initWithTrackSprite_ProgressTimer_ThumbSprite, 3,
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_extension_ControlPotentiometer_create, 3, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_extension_Control_prototype);
    jsb_cocos2d_extension_ControlPotentiometer_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_ControlPotentiometer_class,
...
bool js_cocos2dx_extension_ControlSlider_create(JSContext* cx, uint32_t argc, jsval* vp)
{
    ...
    do
    {
        if (argc == 4)
        {
            ...
            std::string arg3_tmp;
            ok &= jsval_to_std_string(cx, args.get(3), &arg3_tmp);
            arg3 = arg3_tmp.c_str();
            if (!ok)
            {
                ok = true;
...
void js_register_cocos2dx_extension_ControlSlider(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_extension_ControlSlider_create, 3, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_extension_Control_prototype);
    jsb_cocos2d_extension_ControlSlider_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_ControlSlider_class,
...
void js_register_cocos2dx_extension_ControlStepper(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_extension_ControlStepper_create, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_extension_Control_prototype);
    jsb_cocos2d_extension_ControlStepper_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_ControlStepper_class,
...
bool js_cocos2dx_extension_ControlSwitch_initWithMaskSprite(JSContext* cx, uint32_t argc, jsval* vp)
{
    ...
    do
    {
        if (argc == 6)
        {
            ...
            do
            {
                if (args.get(4).isNull())
                {
                    arg4 = nullptr;
                    break;
                }
                if (!args.get(4).isObject())
                {
                    ok = false;
                    break;
                }
            ...
            do
            {
                if (args.get(5).isNull())
                {
                    arg5 = nullptr;
                    break;
                }
                if (!args.get(5).isObject())
                {
                    ok = false;
                    break;
                }
...
void js_register_cocos2dx_extension_ControlSwitch(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("setOn", js_cocos2dx_extension_ControlSwitch_setOn, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_extension_ControlSwitch_create, 4, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_extension_Control_prototype);
    jsb_cocos2d_extension_ControlSwitch_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_ControlSwitch_class,
...
void js_register_cocos2dx_extension_ScrollView(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_extension_ScrollView_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Layer_prototype);
    jsb_cocos2d_extension_ScrollView_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_ScrollView_class,
...
void js_register_cocos2dx_extension_TableViewCell(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("reset", js_cocos2dx_extension_TableViewCell_reset, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     ...
                                     JS_FN("ctor", js_cocos2dx_extension_TableViewCell_ctor, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_extension_TableViewCell_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Node_prototype);
    jsb_cocos2d_extension_TableViewCell_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_TableViewCell_class,
...
void js_register_cocos2dx_extension_TableView(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("updateCellAtIndex", js_cocos2dx_extension_TableView_updateCellAtIndex, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    jsb_cocos2d_extension_TableView_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_TableView_class,
...
void js_register_cocos2dx_extension_EventAssetsManagerEx(JSContext* cx, JS::HandleObject global)
{
    ...
    jsb_cocos2d_extension_EventAssetsManagerEx_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_EventAssetsManagerEx_class,
...
void js_register_cocos2dx_extension_Manifest(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getManifestFileUrl", js_cocos2dx_extension_Manifest_getManifestFileUrl, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    jsb_cocos2d_extension_Manifest_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocos2d_extension_Manifest_class, empty_constructor, 0, properties,
                                                            funcs,
                                                            NULL, // no static properties
                                                            st_funcs);
...
void js_register_cocos2dx_extension_AssetsManagerEx(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_extension_AssetsManagerEx_create, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocos2d_extension_AssetsManagerEx_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocos2d_extension_AssetsManagerEx_class,
...
void js_register_cocos2dx_extension_EventListenerAssetsManagerEx(JSContext* cx, JS::HandleObject global)
{
    ...
    jsb_cocos2d_extension_EventListenerAssetsManagerEx_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_extension_EventListenerAssetsManagerEx_class,
