...
void js_register_cocos2dx_navmesh_NavMeshAgent(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {
        ...
        JS_FN("create", js_cocos2dx_navmesh_NavMeshAgent_create, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Component_prototype);
    jsb_cocos2d_NavMeshAgent_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_NavMeshAgent_class, js_cocos2dx_navmesh_NavMeshAgent_constructor,
                                                      0, // constructor
                                                      properties, funcs,
...
void js_register_cocos2dx_navmesh_NavMeshObstacle(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getSyncFlag", js_cocos2dx_navmesh_NavMeshObstacle_getSyncFlag, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JS::RootedObject parent_proto(cx, jsb_cocos2d_Component_prototype);
    jsb_cocos2d_NavMeshObstacle_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_NavMeshObstacle_class,
...
void js_register_cocos2dx_navmesh_NavMesh(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("removeNavMeshObstacle", js_cocos2dx_navmesh_NavMesh_removeNavMeshObstacle, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_navmesh_NavMesh_create, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocos2d_NavMesh_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocos2d_NavMesh_class, js_cocos2dx_navmesh_NavMesh_constructor, 0, // constructor
                                                 properties, funcs,
                                                 NULL, // no static properties
                                                 st_funcs);
