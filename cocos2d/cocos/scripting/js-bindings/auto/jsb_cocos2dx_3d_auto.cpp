...
void js_register_cocos2dx_3d_Animation3D(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("initWithFile", js_cocos2dx_3d_Animation3D_initWithFile, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     ...
                                     JS_FN("getDuration", js_cocos2dx_3d_Animation3D_getDuration, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JSFunctionSpec* st_funcs = NULL;

    jsb_cocos2d_Animation3D_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocos2d_Animation3D_class, js_cocos2dx_3d_Animation3D_constructor, 0, // constructor
                                                     properties, funcs,
...
void js_register_cocos2dx_3d_Animate3D(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("setKeyFrameUserInfo", js_cocos2dx_3d_Animate3D_setKeyFrameUserInfo, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_3d_Animate3D_create, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                        ...
                                        JS_FN("setTransitionTime", js_cocos2dx_3d_Animate3D_setTransitionTime, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_ActionInterval_prototype);
    jsb_cocos2d_Animate3D_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_Animate3D_class, js_cocos2dx_3d_Animate3D_constructor, 0, // constructor
                                                   properties, funcs,
                                                   NULL, // no static properties
                                                   st_funcs);
...
void js_register_cocos2dx_3d_TextureCube(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("reloadTexture", js_cocos2dx_3d_TextureCube_reloadTexture, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_3d_TextureCube_create, 6, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Texture2D_prototype);
    jsb_cocos2d_TextureCube_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_TextureCube_class, js_cocos2dx_3d_TextureCube_constructor, 0, // constructor
                                                     properties, funcs,
                                                     NULL, // no static properties
                                                     st_funcs);
...
void js_register_cocos2dx_3d_AttachNode(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_3d_AttachNode_create, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Node_prototype);
    jsb_cocos2d_AttachNode_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_AttachNode_class, js_cocos2dx_3d_AttachNode_constructor, 0, // constructor
                                                    properties, funcs,
                                                    NULL, // no static properties
                                                    st_funcs);
...
void js_register_cocos2dx_3d_BillBoard(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getMode", js_cocos2dx_3d_BillBoard_getMode, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("setMode", js_cocos2dx_3d_BillBoard_setMode, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_3d_BillBoard_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                        JS_FN("createWithTexture", js_cocos2dx_3d_BillBoard_createWithTexture, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Sprite_prototype);
    jsb_cocos2d_BillBoard_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_BillBoard_class, js_cocos2dx_3d_BillBoard_constructor, 0, // constructor
                                                   properties, funcs,
                                                   NULL, // no static properties
                                                   st_funcs);
...
void js_register_cocos2dx_3d_Mesh(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getSkin", js_cocos2dx_3d_Mesh_getSkin, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    jsb_cocos2d_Mesh_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocos2d_Mesh_class, js_cocos2dx_3d_Mesh_constructor, 0, // constructor
                                              properties, funcs,
                                              NULL, // no static properties
                                              st_funcs);
...
void js_register_cocos2dx_3d_Skeleton3D(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("removeAllBones", js_cocos2dx_3d_Skeleton3D_removeAllBones, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    jsb_cocos2d_Skeleton3D_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocos2d_Skeleton3D_class, js_cocos2dx_3d_Skeleton3D_constructor, 0, // constructor
                                                    properties, funcs,
                                                    NULL, // no static properties
                                                    st_funcs);
...
void js_register_cocos2dx_3d_Skybox(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("reload", js_cocos2dx_3d_Skybox_reload, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("init", js_cocos2dx_3d_Skybox_init, 6, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("setTexture", js_cocos2dx_3d_Skybox_setTexture, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_3d_Skybox_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Node_prototype);
    jsb_cocos2d_Skybox_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_Skybox_class, js_cocos2dx_3d_Skybox_constructor, 0, // constructor
                                                properties, funcs,
                                                NULL, // no static properties
                                                st_funcs);
...
void js_register_cocos2dx_3d_Sprite3D(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("setCullFaceEnabled", js_cocos2dx_3d_Sprite3D_setCullFaceEnabled, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_3d_Sprite3D_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Node_prototype);
    jsb_cocos2d_Sprite3D_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_Sprite3D_class, js_cocos2dx_3d_Sprite3D_constructor, 0, // constructor
                                                  properties, funcs,
                                                  NULL, // no static properties
                                                  st_funcs);
...
void js_register_cocos2dx_3d_Sprite3DCache(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("removeSprite3DData", js_cocos2dx_3d_Sprite3DCache_removeSprite3DData, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("removeAllSprite3DData", js_cocos2dx_3d_Sprite3DCache_removeAllSprite3DData, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("destroyInstance", js_cocos2dx_3d_Sprite3DCache_destroyInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                        JS_FN("getInstance", js_cocos2dx_3d_Sprite3DCache_getInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocos2d_Sprite3DCache_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocos2d_Sprite3DCache_class, empty_constructor, 0, properties, funcs,
                                                       NULL, // no static properties
                                                       st_funcs);
...
void js_register_cocos2dx_3d_Terrain(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("initHeightMap", js_cocos2dx_3d_Terrain_initHeightMap, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    JS::RootedObject parent_proto(cx, jsb_cocos2d_Node_prototype);
    jsb_cocos2d_Terrain_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocos2d_Terrain_class, js_cocos2dx_3d_Terrain_constructor, 0, // constructor
                                                 properties, funcs,
                                                 NULL, // no static properties
                                                 st_funcs);
...
#pragma warning NO CONVERSION TO NATIVE FOR NodeDatas
        ...
        ok &= jsval_to_std_string(cx, args.get(3), &arg3);
        std::string arg4_tmp;
        ok &= jsval_to_std_string(cx, args.get(4), &arg4_tmp);
        arg4 = arg4_tmp.c_str();
        JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_3d_Bundle3D_loadObj : Error processing arguments");
...
void js_register_cocos2dx_3d_Bundle3D(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("load", js_cocos2dx_3d_Bundle3D_load, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("createBundle", js_cocos2dx_3d_Bundle3D_createBundle, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                        JS_FN("destroyBundle", js_cocos2dx_3d_Bundle3D_destroyBundle, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                        JS_FN("loadObj", js_cocos2dx_3d_Bundle3D_loadObj, 4, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocos2d_Bundle3D_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocos2d_Bundle3D_class, js_cocos2dx_3d_Bundle3D_constructor, 0, // constructor
                                                  properties, funcs,
                                                  NULL, // no static properties
                                                  st_funcs);
