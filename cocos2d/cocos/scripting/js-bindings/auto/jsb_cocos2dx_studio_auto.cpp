...
void js_register_cocos2dx_studio_ActionObject(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("setCurrentTime", js_cocos2dx_studio_ActionObject_setCurrentTime, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    jsb_cocostudio_ActionObject_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_ActionObject_class,
...
void js_register_cocos2dx_studio_ActionManagerEx(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("destroyInstance", js_cocos2dx_studio_ActionManagerEx_destroyInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                        JS_FN("getInstance", js_cocos2dx_studio_ActionManagerEx_getInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocostudio_ActionManagerEx_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_ActionManagerEx_class, empty_constructor, 0, properties,
                                                            funcs,
                                                            NULL, // no static properties
                                                            st_funcs);
...
void js_register_cocos2dx_studio_BaseData(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getColor", js_cocos2dx_studio_BaseData_getColor, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("setColor", js_cocos2dx_studio_BaseData_setColor, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_BaseData_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocostudio_BaseData_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_BaseData_class, js_cocos2dx_studio_BaseData_constructor,
                                                     0, // constructor
                                                     properties, funcs,
                                                     NULL, // no static properties
                                                     st_funcs);
...
void js_register_cocos2dx_studio_MovementData(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getMovementBoneData", js_cocos2dx_studio_MovementData_getMovementBoneData, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("addMovementBoneData", js_cocos2dx_studio_MovementData_addMovementBoneData, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_MovementData_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocostudio_MovementData_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_MovementData_class,
...
void js_register_cocos2dx_studio_AnimationData(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getMovement", js_cocos2dx_studio_AnimationData_getMovement, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("getMovementCount", js_cocos2dx_studio_AnimationData_getMovementCount, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("addMovement", js_cocos2dx_studio_AnimationData_addMovement, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_AnimationData_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocostudio_AnimationData_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_AnimationData_class,
...
void js_register_cocos2dx_studio_ContourData(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("init", js_cocos2dx_studio_ContourData_init, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("addVertex", js_cocos2dx_studio_ContourData_addVertex, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_ContourData_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocostudio_ContourData_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_ContourData_class, js_cocos2dx_studio_ContourData_constructor,
                                                        0, // constructor
                                                        properties, funcs,
                                                        NULL, // no static properties
                                                        st_funcs);
...
void js_register_cocos2dx_studio_TextureData(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getContourData", js_cocos2dx_studio_TextureData_getContourData, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("init", js_cocos2dx_studio_TextureData_init, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("addContourData", js_cocos2dx_studio_TextureData_addContourData, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_TextureData_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocostudio_TextureData_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_TextureData_class, js_cocos2dx_studio_TextureData_constructor,
                                                        0, // constructor
                                                        properties, funcs,
                                                        NULL, // no static properties
                                                        st_funcs);
...
void js_register_cocos2dx_studio_ProcessBase(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("play", js_cocos2dx_studio_ProcessBase_play, 4, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    jsb_cocostudio_ProcessBase_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_ProcessBase_class, js_cocos2dx_studio_ProcessBase_constructor,
                                                        0, // constructor
                                                        properties, funcs,
                                                        NULL, // no static properties
                                                        st_funcs);
...
void js_register_cocos2dx_studio_Tween(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getAnimation", js_cocos2dx_studio_Tween_getAnimation, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_Tween_create, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_ProcessBase_prototype);
    jsb_cocostudio_Tween_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_Tween_class, js_cocos2dx_studio_Tween_constructor, 0, // constructor
                                                  properties, funcs,
                                                  NULL, // no static properties
                                                  st_funcs);
...
void js_register_cocos2dx_studio_ColliderFilter(JSContext* cx, JS::HandleObject global)
{
    ...
    jsb_cocostudio_ColliderFilter_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_ColliderFilter_class, empty_constructor, 0, properties, funcs,
                                                           NULL, // no static properties
                                                           st_funcs);
...
void js_register_cocos2dx_studio_ColliderBody(JSContext* cx, JS::HandleObject global)
{
    ...
    jsb_cocostudio_ColliderBody_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_ColliderBody_class, empty_constructor, 0, properties, funcs,
                                                         NULL, // no static properties
                                                         st_funcs);
...
void js_register_cocos2dx_studio_ColliderDetector(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getBone", js_cocos2dx_studio_ColliderDetector_getBone, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_ColliderDetector_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocostudio_ColliderDetector_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_ColliderDetector_class, empty_constructor, 0, properties,
                                                             funcs,
                                                             NULL, // no static properties
                                                             st_funcs);
...
void js_register_cocos2dx_studio_DecorativeDisplay(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_DecorativeDisplay_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocostudio_DecorativeDisplay_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_DecorativeDisplay_class, empty_constructor, 0,
                                                              properties, funcs,
                                                              NULL, // no static properties
                                                              st_funcs);
...
void js_register_cocos2dx_studio_DisplayManager(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_DisplayManager_create, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocostudio_DisplayManager_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_DisplayManager_class,
...
void js_register_cocos2dx_studio_Bone(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_Bone_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Node_prototype);
    jsb_cocostudio_Bone_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_Bone_class, js_cocos2dx_studio_Bone_constructor, 0, // constructor
                                                 properties, funcs,
                                                 NULL, // no static properties
                                                 st_funcs);
...
void js_register_cocos2dx_studio_BatchNode(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_BatchNode_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Node_prototype);
    jsb_cocostudio_BatchNode_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_BatchNode_class, empty_constructor, 0, properties, funcs,
                                                      NULL, // no static properties
                                                      st_funcs);
...
void js_register_cocos2dx_studio_ArmatureAnimation(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getSpeedScale", js_cocos2dx_studio_ArmatureAnimation_getSpeedScale, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_ArmatureAnimation_create, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_ProcessBase_prototype);
    jsb_cocostudio_ArmatureAnimation_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_ArmatureAnimation_class,
...
void js_register_cocos2dx_studio_ArmatureDataManager(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("destroyInstance", js_cocos2dx_studio_ArmatureDataManager_destroyInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                        JS_FN("getInstance", js_cocos2dx_studio_ArmatureDataManager_getInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                        JS_FS_END};

    jsb_cocostudio_ArmatureDataManager_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_ArmatureDataManager_class, empty_constructor, 0,
                                                                properties, funcs,
                                                                NULL, // no static properties
                                                                st_funcs);
...
void js_register_cocos2dx_studio_Armature(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_Armature_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Node_prototype);
    jsb_cocostudio_Armature_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_Armature_class, js_cocos2dx_studio_Armature_constructor, 0, // constructor
                                                     properties, funcs,
                                                     NULL, // no static properties
                                                     st_funcs);
...
void js_register_cocos2dx_studio_Skin(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getBone", js_cocos2dx_studio_Skin_getBone, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {
        ...
        JS_FN("createWithSpriteFrameName", js_cocos2dx_studio_Skin_createWithSpriteFrameName, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Sprite_prototype);
    jsb_cocostudio_Skin_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_Skin_class, js_cocos2dx_studio_Skin_constructor, 0, // constructor
                                                 properties, funcs,
                                                 NULL, // no static properties
                                                 st_funcs);
...
void js_register_cocos2dx_studio_ComAttribute(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getFloat", js_cocos2dx_studio_ComAttribute_getFloat, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_ComAttribute_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Component_prototype);
    jsb_cocostudio_ComAttribute_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_ComAttribute_class,
...
void js_register_cocos2dx_studio_ComAudio(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_ComAudio_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Component_prototype);
    jsb_cocostudio_ComAudio_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_ComAudio_class, js_cocos2dx_studio_ComAudio_constructor, 0, // constructor
                                                     properties, funcs,
                                                     NULL, // no static properties
                                                     st_funcs);
...
void js_register_cocos2dx_studio_InputDelegate(JSContext* cx, JS::HandleObject global)
{
    ...
    jsb_cocostudio_InputDelegate_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_InputDelegate_class, empty_constructor, 0, properties, funcs,
                                                          NULL, // no static properties
                                                          st_funcs);
...
void js_register_cocos2dx_studio_ComController(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("ctor", js_cocos2dx_studio_ComController_ctor, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_ComController_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Component_prototype);
    jsb_cocostudio_ComController_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_ComController_class,
...
void js_register_cocos2dx_studio_ComRender(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("setNode", js_cocos2dx_studio_ComRender_setNode, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("getNode", js_cocos2dx_studio_ComRender_getNode, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_ComRender_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Component_prototype);
    jsb_cocostudio_ComRender_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_ComRender_class, js_cocos2dx_studio_ComRender_constructor,
                                                      0, // constructor
                                                      properties, funcs,
                                                      NULL, // no static properties
                                                      st_funcs);
...
void js_register_cocos2dx_studio_Frame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("clone", js_cocos2dx_studio_Frame_clone, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    jsb_cocostudio_timeline_Frame_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_timeline_Frame_class,
...
void js_register_cocos2dx_studio_VisibleFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("isVisible", js_cocos2dx_studio_VisibleFrame_isVisible, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("setVisible", js_cocos2dx_studio_VisibleFrame_setVisible, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_VisibleFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_Frame_prototype);
    jsb_cocostudio_timeline_VisibleFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_VisibleFrame_class,
...
void js_register_cocos2dx_studio_TextureFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getTextureName", js_cocos2dx_studio_TextureFrame_getTextureName, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("setTextureName", js_cocos2dx_studio_TextureFrame_setTextureName, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_TextureFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_Frame_prototype);
    jsb_cocostudio_timeline_TextureFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_TextureFrame_class,
...
void js_register_cocos2dx_studio_RotationFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("setRotation", js_cocos2dx_studio_RotationFrame_setRotation, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("getRotation", js_cocos2dx_studio_RotationFrame_getRotation, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_RotationFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_Frame_prototype);
    jsb_cocostudio_timeline_RotationFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_RotationFrame_class,
...
void js_register_cocos2dx_studio_SkewFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getSkewY", js_cocos2dx_studio_SkewFrame_getSkewY, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     ...
                                     JS_FN("getSkewX", js_cocos2dx_studio_SkewFrame_getSkewX, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_SkewFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_Frame_prototype);
    jsb_cocostudio_timeline_SkewFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_SkewFrame_class,
...
void js_register_cocos2dx_studio_RotationSkewFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_RotationSkewFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_SkewFrame_prototype);
    jsb_cocostudio_timeline_RotationSkewFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_RotationSkewFrame_class,
...
void js_register_cocos2dx_studio_PositionFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getX", js_cocos2dx_studio_PositionFrame_getX, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_PositionFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_Frame_prototype);
    jsb_cocostudio_timeline_PositionFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_PositionFrame_class,
...
void js_register_cocos2dx_studio_ScaleFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("setScaleY", js_cocos2dx_studio_ScaleFrame_setScaleY, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_ScaleFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_Frame_prototype);
    jsb_cocostudio_timeline_ScaleFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_ScaleFrame_class,
...
void js_register_cocos2dx_studio_AnchorPointFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("setAnchorPoint", js_cocos2dx_studio_AnchorPointFrame_setAnchorPoint, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("getAnchorPoint", js_cocos2dx_studio_AnchorPointFrame_getAnchorPoint, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_AnchorPointFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_Frame_prototype);
    jsb_cocostudio_timeline_AnchorPointFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_AnchorPointFrame_class,
...
void js_register_cocos2dx_studio_InnerActionFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_InnerActionFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_Frame_prototype);
    jsb_cocostudio_timeline_InnerActionFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_InnerActionFrame_class,
...
void js_register_cocos2dx_studio_ColorFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getColor", js_cocos2dx_studio_ColorFrame_getColor, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("setColor", js_cocos2dx_studio_ColorFrame_setColor, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_ColorFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_Frame_prototype);
    jsb_cocostudio_timeline_ColorFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_ColorFrame_class,
...
void js_register_cocos2dx_studio_AlphaFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getAlpha", js_cocos2dx_studio_AlphaFrame_getAlpha, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("setAlpha", js_cocos2dx_studio_AlphaFrame_setAlpha, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_AlphaFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_Frame_prototype);
    jsb_cocostudio_timeline_AlphaFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_AlphaFrame_class,
...
void js_register_cocos2dx_studio_EventFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("setEvent", js_cocos2dx_studio_EventFrame_setEvent, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("init", js_cocos2dx_studio_EventFrame_init, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("getEvent", js_cocos2dx_studio_EventFrame_getEvent, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_EventFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_Frame_prototype);
    jsb_cocostudio_timeline_EventFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_EventFrame_class,
...
void js_register_cocos2dx_studio_ZOrderFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getZOrder", js_cocos2dx_studio_ZOrderFrame_getZOrder, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("setZOrder", js_cocos2dx_studio_ZOrderFrame_setZOrder, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_ZOrderFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_Frame_prototype);
    jsb_cocostudio_timeline_ZOrderFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_ZOrderFrame_class,
...
void js_register_cocos2dx_studio_BlendFuncFrame(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getBlendFunc", js_cocos2dx_studio_BlendFuncFrame_getBlendFunc, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("setBlendFunc", js_cocos2dx_studio_BlendFuncFrame_setBlendFunc, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_BlendFuncFrame_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_Frame_prototype);
    jsb_cocostudio_timeline_BlendFuncFrame_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_BlendFuncFrame_class,
...
void js_register_cocos2dx_studio_Timeline(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("clone", js_cocos2dx_studio_Timeline_clone, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_Timeline_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocostudio_timeline_Timeline_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_timeline_Timeline_class,
...
void js_register_cocos2dx_studio_ActionTimelineData(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("setActionTag", js_cocos2dx_studio_ActionTimelineData_setActionTag, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("init", js_cocos2dx_studio_ActionTimelineData_init, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("getActionTag", js_cocos2dx_studio_ActionTimelineData_getActionTag, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_ActionTimelineData_create, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    jsb_cocostudio_timeline_ActionTimelineData_prototype = JS_InitClass(cx, global, JS::NullPtr(), jsb_cocostudio_timeline_ActionTimelineData_class,
...
void js_register_cocos2dx_studio_ActionTimeline(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_ActionTimeline_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Action_prototype);
    jsb_cocostudio_timeline_ActionTimeline_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_ActionTimeline_class,
...
void js_register_cocos2dx_studio_BoneNode(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getDebugDrawWidth", js_cocos2dx_studio_BoneNode_getDebugDrawWidth, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_BoneNode_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Node_prototype);
    jsb_cocostudio_timeline_BoneNode_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_BoneNode_class,
...
void js_register_cocos2dx_studio_SkeletonNode(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("getBoneNode", js_cocos2dx_studio_SkeletonNode_getBoneNode, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_SkeletonNode_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocostudio_timeline_BoneNode_prototype);
    jsb_cocostudio_timeline_SkeletonNode_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_timeline_SkeletonNode_class,
...
void js_register_cocos2dx_studio_ComExtensionData(JSContext* cx, JS::HandleObject global)
{
    ...
    static JSFunctionSpec funcs[] = {JS_FN("setActionTag", js_cocos2dx_studio_ComExtensionData_setActionTag, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {JS_FN("create", js_cocos2dx_studio_ComExtensionData_create, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};

    JS::RootedObject parent_proto(cx, jsb_cocos2d_Component_prototype);
    jsb_cocostudio_ComExtensionData_prototype = JS_InitClass(cx, global, parent_proto, jsb_cocostudio_ComExtensionData_class,
