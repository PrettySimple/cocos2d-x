...
namespace cocostudio
{
    ...
    Offset<Table> WidgetReader::createOptionsWithFlatBuffers(const tinyxml2::XMLElement* objectData, flatbuffers::FlatBufferBuilder* builder)
    {
        ...
        auto options = CreateWidgetOptions(*builder, builder->CreateString(name), (int32_t)actionTag, &f_rotationskew, zOrder, visible, alpha, tag, &f_position,
                                           ...
                                           builder->CreateString(callbackName), f_layoutComponent);
