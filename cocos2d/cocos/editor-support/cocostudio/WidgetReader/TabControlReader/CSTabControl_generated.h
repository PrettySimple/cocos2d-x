...
namespace flatbuffers
{
    ...
    struct TabControlOption : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* nodeOptions */) && verifier.VerifyTable(nodeOptions()) &&
                VerifyField<int32_t>(verifier, 6 /* headerPlace */) && VerifyField<int32_t>(verifier, 8 /* headerWidth */) &&
                VerifyField<int32_t>(verifier, 10 /* headerHeight */) && VerifyField<float>(verifier, 12 /* selectedTabZoom */) &&
                VerifyField<int32_t>(verifier, 14 /* selectedTabIndex */) && VerifyField<uint8_t>(verifier, 16 /* ignoreHeaderTextureSize */) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 18 /* tabItems */) && verifier.Verify(tabItems()) && verifier.VerifyVectorOfTables(tabItems()) &&
                verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<TabControlOption>
    CreateTabControlOption(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> nodeOptions = 0, int32_t headerPlace = 0,
                           int32_t headerWidth = 0, int32_t headerHeight = 0, float selectedTabZoom = 0, int32_t selectedTabIndex = 0,
                           uint8_t ignoreHeaderTextureSize = 0, flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<TabItemOption>>> tabItems = 0)
    {
    ...
    struct TabHeaderOption : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* nodeOptions */) && verifier.VerifyTable(nodeOptions()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* fontRes */) && verifier.VerifyTable(fontRes()) &&
                VerifyField<int32_t>(verifier, 8 /* fontSize */) && VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* titleText */) &&
                verifier.Verify(titleText()) && VerifyField<Color>(verifier, 12 /* textColor */) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 14 /* normalBackFile */) && verifier.VerifyTable(normalBackFile()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 16 /* pressBackFile */) && verifier.VerifyTable(pressBackFile()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 18 /* disableBackFile */) && verifier.VerifyTable(disableBackFile()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 20 /* crossNormalFile */) && verifier.VerifyTable(crossNormalFile()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 22 /* crossDisableFile */) && verifier.VerifyTable(crossDisableFile()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<TabHeaderOption>
    CreateTabHeaderOption(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> nodeOptions = 0,
                          flatbuffers::Offset<ResourceData> fontRes = 0, int32_t fontSize = 0, flatbuffers::Offset<flatbuffers::String> titleText = 0,
                          const Color* textColor = 0, flatbuffers::Offset<ResourceData> normalBackFile = 0, flatbuffers::Offset<ResourceData> pressBackFile = 0,
                          flatbuffers::Offset<ResourceData> disableBackFile = 0, flatbuffers::Offset<ResourceData> crossNormalFile = 0,
    ...
    struct TabItemOption : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* header */) && verifier.VerifyTable(header()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* container */) && verifier.VerifyTable(container()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<TabItemOption>
    CreateTabItemOption(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<TabHeaderOption> header = 0, flatbuffers::Offset<NodeTree> container = 0)
    {
