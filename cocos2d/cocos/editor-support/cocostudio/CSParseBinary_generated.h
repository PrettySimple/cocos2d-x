...
namespace flatbuffers
{
    ...
    public:
        ...
        : rotationSkewX_(flatbuffers::EndianScalar(rotationSkewX))
        , rotationSkewY_(flatbuffers::EndianScalar(rotationSkewY))
        {
        }
    ...
    public:
        ...
        : scaleX_(flatbuffers::EndianScalar(scaleX))
        , scaleY_(flatbuffers::EndianScalar(scaleY))
        {
        }
    ...
    public:
        ...
        : a_(flatbuffers::EndianScalar(a))
        , r_(flatbuffers::EndianScalar(r))
        , g_(flatbuffers::EndianScalar(g))
        , b_(flatbuffers::EndianScalar(b))
        {
        }
    ...
    public:
        ...
        : vectorX_(flatbuffers::EndianScalar(vectorX))
        , vectorY_(flatbuffers::EndianScalar(vectorY))
        {
        }
    ...
    public:
        ...
        : width_(flatbuffers::EndianScalar(width))
        , height_(flatbuffers::EndianScalar(height))
        {
        }
    ...
    public:
        ...
        : src_(flatbuffers::EndianScalar(src))
        , dst_(flatbuffers::EndianScalar(dst))
        {
        }
    ...
    struct CSParseBinary : private flatbuffers::Table
    {
        ...
        {
            return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>*>(6);
        }
        ...
        {
            return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<AnimationInfo>>*>(14);
        }
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* version */) && verifier.Verify(version()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* textures */) && verifier.Verify(textures()) && verifier.VerifyVectorOfStrings(textures()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* texturePngs */) && verifier.Verify(texturePngs()) &&
                verifier.VerifyVectorOfStrings(texturePngs()) && VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* nodeTree */) &&
                verifier.VerifyTable(nodeTree()) && VerifyField<flatbuffers::uoffset_t>(verifier, 12 /* action */) && verifier.VerifyTable(action()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 14 /* animationList */) && verifier.Verify(animationList()) &&
    ...
    struct CSParseBinaryBuilder
    {
        ...
        {
            fbb_.AddOffset(14, animationList);
        }
    ...
    inline flatbuffers::Offset<CSParseBinary>
    CreateCSParseBinary(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<flatbuffers::String> version = 0,
                        ...
                        flatbuffers::Offset<NodeTree> nodeTree = 0, flatbuffers::Offset<NodeAction> action = 0,
    ...
    struct NodeTree : private flatbuffers::Table
    {
        ...
        {
            return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<NodeTree>>*>(6);
        }
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* classname */) && verifier.Verify(classname()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* children */) && verifier.Verify(children()) && verifier.VerifyVectorOfTables(children()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* options */) && verifier.VerifyTable(options()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* customClassName */) && verifier.Verify(customClassName()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<NodeTree> CreateNodeTree(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<flatbuffers::String> classname = 0,
    ...
    struct WidgetOptions : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* name */) && verifier.Verify(name()) &&
                VerifyField<int32_t>(verifier, 6 /* actionTag */) && VerifyField<RotationSkew>(verifier, 8 /* rotationSkew */) &&
                VerifyField<int32_t>(verifier, 10 /* zOrder */) && VerifyField<uint8_t>(verifier, 12 /* visible */) &&
                VerifyField<uint8_t>(verifier, 14 /* alpha */) && VerifyField<int32_t>(verifier, 16 /* tag */) &&
                VerifyField<Position>(verifier, 18 /* position */) && VerifyField<Scale>(verifier, 20 /* scale */) &&
                VerifyField<AnchorPoint>(verifier, 22 /* anchorPoint */) && VerifyField<Color>(verifier, 24 /* color */) &&
                VerifyField<FlatSize>(verifier, 26 /* size */) && VerifyField<uint8_t>(verifier, 28 /* flipX */) &&
                VerifyField<uint8_t>(verifier, 30 /* flipY */) && VerifyField<uint8_t>(verifier, 32 /* ignoreSize */) &&
                VerifyField<uint8_t>(verifier, 34 /* touchEnabled */) && VerifyField<flatbuffers::uoffset_t>(verifier, 36 /* frameEvent */) &&
                verifier.Verify(frameEvent()) && VerifyField<flatbuffers::uoffset_t>(verifier, 38 /* customProperty */) && verifier.Verify(customProperty()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 40 /* callBackType */) && verifier.Verify(callBackType()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 42 /* callBackName */) && verifier.Verify(callBackName()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 44 /* layoutComponent */) && verifier.VerifyTable(layoutComponent()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<WidgetOptions>
    CreateWidgetOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<flatbuffers::String> name = 0, int32_t actionTag = 0,
                        const RotationSkew* rotationSkew = 0, int32_t zOrder = 0, uint8_t visible = 1, uint8_t alpha = 255, int32_t tag = 0,
                        const Position* position = 0, const Scale* scale = 0, const AnchorPoint* anchorPoint = 0, const Color* color = 0,
                        const FlatSize* size = 0, uint8_t flipX = 0, uint8_t flipY = 0, uint8_t ignoreSize = 0, uint8_t touchEnabled = 0,
                        flatbuffers::Offset<flatbuffers::String> frameEvent = 0, flatbuffers::Offset<flatbuffers::String> customProperty = 0,
                        flatbuffers::Offset<flatbuffers::String> callBackType = 0, flatbuffers::Offset<flatbuffers::String> callBackName = 0,
    ...
    struct LayoutComponentTable : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<uint8_t>(verifier, 4 /* positionXPercentEnabled */) &&
                VerifyField<uint8_t>(verifier, 6 /* positionYPercentEnabled */) && VerifyField<float>(verifier, 8 /* positionXPercent */) &&
                VerifyField<float>(verifier, 10 /* positionYPercent */) && VerifyField<uint8_t>(verifier, 12 /* sizeXPercentEnable */) &&
                VerifyField<uint8_t>(verifier, 14 /* sizeYPercentEnable */) && VerifyField<float>(verifier, 16 /* sizeXPercent */) &&
                VerifyField<float>(verifier, 18 /* sizeYPercent */) && VerifyField<uint8_t>(verifier, 20 /* stretchHorizontalEnabled */) &&
                VerifyField<uint8_t>(verifier, 22 /* stretchVerticalEnabled */) && VerifyField<flatbuffers::uoffset_t>(verifier, 24 /* horizontalEdge */) &&
                verifier.Verify(horizontalEdge()) && VerifyField<flatbuffers::uoffset_t>(verifier, 26 /* verticalEdge */) && verifier.Verify(verticalEdge()) &&
                VerifyField<float>(verifier, 28 /* leftMargin */) && VerifyField<float>(verifier, 30 /* rightMargin */) &&
    ...
    inline flatbuffers::Offset<LayoutComponentTable>
    CreateLayoutComponentTable(flatbuffers::FlatBufferBuilder& _fbb, uint8_t positionXPercentEnabled = 0, uint8_t positionYPercentEnabled = 0,
                               float positionXPercent = 0, float positionYPercent = 0, uint8_t sizeXPercentEnable = 0, uint8_t sizeYPercentEnable = 0,
                               float sizeXPercent = 0, float sizeYPercent = 0, uint8_t stretchHorizontalEnabled = 0, uint8_t stretchVerticalEnabled = 0,
                               flatbuffers::Offset<flatbuffers::String> horizontalEdge = 0, flatbuffers::Offset<flatbuffers::String> verticalEdge = 0,
    ...
    struct SingleNodeOptions : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* nodeOptions */) && verifier.VerifyTable(nodeOptions()) &&
                verifier.EndTable();
        }
    };
    ...
    struct SpriteOptions : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* nodeOptions */) && verifier.VerifyTable(nodeOptions()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* fileNameData */) && verifier.VerifyTable(fileNameData()) &&
                VerifyField<BlendFunc>(verifier, 8 /* blendFunc */) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<SpriteOptions> CreateSpriteOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> nodeOptions = 0,
                                                                  flatbuffers::Offset<ResourceData> fileNameData = 0, const BlendFunc* blendFunc = 0)
    {
    ...
    inline flatbuffers::Offset<ParticleSystemOptions>
    CreateParticleSystemOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> nodeOptions = 0,
                                flatbuffers::Offset<ResourceData> fileNameData = 0, const BlendFunc* blendFunc = 0)
    {
    ...
    struct GameMapOptions : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* nodeOptions */) && verifier.VerifyTable(nodeOptions()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* fileNameData */) && verifier.VerifyTable(fileNameData()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<GameMapOptions> CreateGameMapOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> nodeOptions = 0,
    ...
    struct ButtonOptions : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* widgetOptions */) &&
                verifier.VerifyTable(widgetOptions()) && VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* normalData */) &&
                verifier.VerifyTable(normalData()) && VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* pressedData */) &&
                verifier.VerifyTable(pressedData()) && VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* disabledData */) &&
                verifier.VerifyTable(disabledData()) && VerifyField<flatbuffers::uoffset_t>(verifier, 12 /* fontResource */) &&
                verifier.VerifyTable(fontResource()) && VerifyField<flatbuffers::uoffset_t>(verifier, 14 /* text */) && verifier.Verify(text()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 16 /* fontName */) && verifier.Verify(fontName()) &&
                VerifyField<int32_t>(verifier, 18 /* fontSize */) && VerifyField<Color>(verifier, 20 /* textColor */) &&
                VerifyField<CapInsets>(verifier, 22 /* capInsets */) && VerifyField<FlatSize>(verifier, 24 /* scale9Size */) &&
                VerifyField<uint8_t>(verifier, 26 /* scale9Enabled */) && VerifyField<uint8_t>(verifier, 28 /* displaystate */) &&
                VerifyField<uint8_t>(verifier, 30 /* outlineEnabled */) && VerifyField<Color>(verifier, 32 /* outlineColor */) &&
                VerifyField<int32_t>(verifier, 34 /* outlineSize */) && VerifyField<uint8_t>(verifier, 36 /* shadowEnabled */) &&
                VerifyField<Color>(verifier, 38 /* shadowColor */) && VerifyField<float>(verifier, 40 /* shadowOffsetX */) &&
                VerifyField<float>(verifier, 42 /* shadowOffsetY */) && VerifyField<int32_t>(verifier, 44 /* shadowBlurRadius */) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<ButtonOptions>
    CreateButtonOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> widgetOptions = 0,
                        flatbuffers::Offset<ResourceData> normalData = 0, flatbuffers::Offset<ResourceData> pressedData = 0,
                        flatbuffers::Offset<ResourceData> disabledData = 0, flatbuffers::Offset<ResourceData> fontResource = 0,
                        flatbuffers::Offset<flatbuffers::String> text = 0, flatbuffers::Offset<flatbuffers::String> fontName = 0, int32_t fontSize = 0,
                        const Color* textColor = 0, const CapInsets* capInsets = 0, const FlatSize* scale9Size = 0, uint8_t scale9Enabled = 0,
                        uint8_t displaystate = 1, uint8_t outlineEnabled = 0, const Color* outlineColor = 0, int32_t outlineSize = 1, uint8_t shadowEnabled = 0,
                        const Color* shadowColor = 0, float shadowOffsetX = 2, float shadowOffsetY = -2, int32_t shadowBlurRadius = 0)
    {
    ...
    struct CheckBoxOptions : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* widgetOptions */) && verifier.VerifyTable(widgetOptions()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* backGroundBoxData */) && verifier.VerifyTable(backGroundBoxData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* backGroundBoxSelectedData */) && verifier.VerifyTable(backGroundBoxSelectedData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* frontCrossData */) && verifier.VerifyTable(frontCrossData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 12 /* backGroundBoxDisabledData */) && verifier.VerifyTable(backGroundBoxDisabledData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 14 /* frontCrossDisabledData */) && verifier.VerifyTable(frontCrossDisabledData()) &&
    ...
    inline flatbuffers::Offset<CheckBoxOptions>
    CreateCheckBoxOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> widgetOptions = 0,
                          flatbuffers::Offset<ResourceData> backGroundBoxData = 0, flatbuffers::Offset<ResourceData> backGroundBoxSelectedData = 0,
                          flatbuffers::Offset<ResourceData> frontCrossData = 0, flatbuffers::Offset<ResourceData> backGroundBoxDisabledData = 0,
    ...
    struct ImageViewOptions : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* widgetOptions */) &&
                verifier.VerifyTable(widgetOptions()) && VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* fileNameData */) &&
                verifier.VerifyTable(fileNameData()) && VerifyField<CapInsets>(verifier, 8 /* capInsets */) &&
                VerifyField<FlatSize>(verifier, 10 /* scale9Size */) && VerifyField<uint8_t>(verifier, 12 /* scale9Enabled */) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<ImageViewOptions> CreateImageViewOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> widgetOptions = 0,
                                                                        flatbuffers::Offset<ResourceData> fileNameData = 0, const CapInsets* capInsets = 0,
    ...
    struct TextAtlasOptions : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* widgetOptions */) &&
                verifier.VerifyTable(widgetOptions()) && VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* charMapFileData */) &&
                verifier.VerifyTable(charMapFileData()) && VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* stringValue */) &&
                verifier.Verify(stringValue()) && VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* startCharMap */) && verifier.Verify(startCharMap()) &&
                VerifyField<int32_t>(verifier, 12 /* itemWidth */) && VerifyField<int32_t>(verifier, 14 /* itemHeight */) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<TextAtlasOptions>
    CreateTextAtlasOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> widgetOptions = 0,
                           flatbuffers::Offset<ResourceData> charMapFileData = 0, flatbuffers::Offset<flatbuffers::String> stringValue = 0,
                           flatbuffers::Offset<flatbuffers::String> startCharMap = 0, int32_t itemWidth = 0, int32_t itemHeight = 0)
    {
    ...
    struct TextBMFontOptions : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* widgetOptions */) && verifier.VerifyTable(widgetOptions()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* fileNameData */) && verifier.VerifyTable(fileNameData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* text */) && verifier.Verify(text()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<TextBMFontOptions>
    CreateTextBMFontOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> widgetOptions = 0,
                            flatbuffers::Offset<ResourceData> fileNameData = 0, flatbuffers::Offset<flatbuffers::String> text = 0)
    {
    ...
    struct TextOptions : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* widgetOptions */) &&
                verifier.VerifyTable(widgetOptions()) && VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* fontResource */) &&
                verifier.VerifyTable(fontResource()) && VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* fontName */) && verifier.Verify(fontName()) &&
                VerifyField<int32_t>(verifier, 10 /* fontSize */) && VerifyField<flatbuffers::uoffset_t>(verifier, 12 /* text */) && verifier.Verify(text()) &&
                VerifyField<int32_t>(verifier, 14 /* areaWidth */) && VerifyField<int32_t>(verifier, 16 /* areaHeight */) &&
                VerifyField<int32_t>(verifier, 18 /* hAlignment */) && VerifyField<int32_t>(verifier, 20 /* vAlignment */) &&
                VerifyField<uint8_t>(verifier, 22 /* touchScaleEnable */) && VerifyField<uint8_t>(verifier, 24 /* isCustomSize */) &&
                VerifyField<uint8_t>(verifier, 26 /* outlineEnabled */) && VerifyField<Color>(verifier, 28 /* outlineColor */) &&
                VerifyField<int32_t>(verifier, 30 /* outlineSize */) && VerifyField<uint8_t>(verifier, 32 /* shadowEnabled */) &&
                VerifyField<Color>(verifier, 34 /* shadowColor */) && VerifyField<float>(verifier, 36 /* shadowOffsetX */) &&
                VerifyField<float>(verifier, 38 /* shadowOffsetY */) && VerifyField<int32_t>(verifier, 40 /* shadowBlurRadius */) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<TextOptions>
    CreateTextOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> widgetOptions = 0,
                      flatbuffers::Offset<ResourceData> fontResource = 0, flatbuffers::Offset<flatbuffers::String> fontName = 0, int32_t fontSize = 0,
                      flatbuffers::Offset<flatbuffers::String> text = 0, int32_t areaWidth = 0, int32_t areaHeight = 0, int32_t hAlignment = 0,
                      int32_t vAlignment = 0, uint8_t touchScaleEnable = 0, uint8_t isCustomSize = 0, uint8_t outlineEnabled = 0, const Color* outlineColor = 0,
                      int32_t outlineSize = 1, uint8_t shadowEnabled = 0, const Color* shadowColor = 0, float shadowOffsetX = 2, float shadowOffsetY = -2,
    ...
    struct TextFieldOptions : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* widgetOptions */) &&
                ...
                verifier.VerifyTable(fontResource()) && VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* fontName */) && verifier.Verify(fontName()) &&
                VerifyField<int32_t>(verifier, 10 /* fontSize */) && VerifyField<flatbuffers::uoffset_t>(verifier, 12 /* text */) && verifier.Verify(text()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 14 /* placeHolder */) && verifier.Verify(placeHolder()) &&
                VerifyField<uint8_t>(verifier, 16 /* passwordEnabled */) && VerifyField<flatbuffers::uoffset_t>(verifier, 18 /* passwordStyleText */) &&
                verifier.Verify(passwordStyleText()) && VerifyField<uint8_t>(verifier, 20 /* maxLengthEnabled */) &&
                VerifyField<int32_t>(verifier, 22 /* maxLength */) && VerifyField<int32_t>(verifier, 24 /* areaWidth */) &&
                VerifyField<int32_t>(verifier, 26 /* areaHeight */) && VerifyField<uint8_t>(verifier, 28 /* isCustomSize */) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<TextFieldOptions>
    CreateTextFieldOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> widgetOptions = 0,
                           flatbuffers::Offset<ResourceData> fontResource = 0, flatbuffers::Offset<flatbuffers::String> fontName = 0, int32_t fontSize = 0,
                           flatbuffers::Offset<flatbuffers::String> text = 0, flatbuffers::Offset<flatbuffers::String> placeHolder = 0,
                           uint8_t passwordEnabled = 0, flatbuffers::Offset<flatbuffers::String> passwordStyleText = 0, uint8_t maxLengthEnabled = 0,
    ...
    struct LoadingBarOptions : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* widgetOptions */) && verifier.VerifyTable(widgetOptions()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* textureData */) && verifier.VerifyTable(textureData()) &&
                VerifyField<int32_t>(verifier, 8 /* percent */) && VerifyField<int32_t>(verifier, 10 /* direction */) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<LoadingBarOptions>
    CreateLoadingBarOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> widgetOptions = 0,
                            flatbuffers::Offset<ResourceData> textureData = 0, int32_t percent = 80, int32_t direction = 0)
    {
    ...
    struct SliderOptions : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* widgetOptions */) && verifier.VerifyTable(widgetOptions()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* barFileNameData */) && verifier.VerifyTable(barFileNameData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* ballNormalData */) && verifier.VerifyTable(ballNormalData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* ballPressedData */) && verifier.VerifyTable(ballPressedData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 12 /* ballDisabledData */) && verifier.VerifyTable(ballDisabledData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 14 /* progressBarData */) && verifier.VerifyTable(progressBarData()) &&
                VerifyField<int32_t>(verifier, 16 /* percent */) && VerifyField<uint8_t>(verifier, 18 /* displaystate */) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<SliderOptions>
    CreateSliderOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> widgetOptions = 0,
                        flatbuffers::Offset<ResourceData> barFileNameData = 0, flatbuffers::Offset<ResourceData> ballNormalData = 0,
                        flatbuffers::Offset<ResourceData> ballPressedData = 0, flatbuffers::Offset<ResourceData> ballDisabledData = 0,
    ...
    struct PanelOptions : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* widgetOptions */) && verifier.VerifyTable(widgetOptions()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* backGroundImageData */) && verifier.VerifyTable(backGroundImageData()) &&
                VerifyField<uint8_t>(verifier, 8 /* clipEnabled */) && VerifyField<Color>(verifier, 10 /* bgColor */) &&
                VerifyField<Color>(verifier, 12 /* bgStartColor */) && VerifyField<Color>(verifier, 14 /* bgEndColor */) &&
                VerifyField<int32_t>(verifier, 16 /* colorType */) && VerifyField<uint8_t>(verifier, 18 /* bgColorOpacity */) &&
                VerifyField<ColorVector>(verifier, 20 /* colorVector */) && VerifyField<CapInsets>(verifier, 22 /* capInsets */) &&
                VerifyField<FlatSize>(verifier, 24 /* scale9Size */) && VerifyField<uint8_t>(verifier, 26 /* backGroundScale9Enabled */) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<PanelOptions>
    CreatePanelOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> widgetOptions = 0,
                       flatbuffers::Offset<ResourceData> backGroundImageData = 0, uint8_t clipEnabled = 0, const Color* bgColor = 0,
                       const Color* bgStartColor = 0, const Color* bgEndColor = 0, int32_t colorType = 0, uint8_t bgColorOpacity = 255,
                       const ColorVector* colorVector = 0, const CapInsets* capInsets = 0, const FlatSize* scale9Size = 0, uint8_t backGroundScale9Enabled = 0)
    {
    ...
    struct ScrollViewOptions : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* widgetOptions */) && verifier.VerifyTable(widgetOptions()) &&
                ...
                VerifyField<int32_t>(verifier, 16 /* colorType */) && VerifyField<uint8_t>(verifier, 18 /* bgColorOpacity */) &&
                VerifyField<ColorVector>(verifier, 20 /* colorVector */) && VerifyField<CapInsets>(verifier, 22 /* capInsets */) &&
                VerifyField<FlatSize>(verifier, 24 /* scale9Size */) && VerifyField<uint8_t>(verifier, 26 /* backGroundScale9Enabled */) &&
                VerifyField<FlatSize>(verifier, 28 /* innerSize */) && VerifyField<int32_t>(verifier, 30 /* direction */) &&
                VerifyField<uint8_t>(verifier, 32 /* bounceEnabled */) && VerifyField<uint8_t>(verifier, 34 /* scrollbarEnabeld */) &&
                VerifyField<uint8_t>(verifier, 36 /* scrollbarAutoHide */) && VerifyField<float>(verifier, 38 /* scrollbarAutoHideTime */) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<ScrollViewOptions>
    CreateScrollViewOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> widgetOptions = 0,
                            flatbuffers::Offset<ResourceData> backGroundImageData = 0, uint8_t clipEnabled = 0, const Color* bgColor = 0,
                            const Color* bgStartColor = 0, const Color* bgEndColor = 0, int32_t colorType = 0, uint8_t bgColorOpacity = 255,
                            const ColorVector* colorVector = 0, const CapInsets* capInsets = 0, const FlatSize* scale9Size = 0,
                            uint8_t backGroundScale9Enabled = 0, const FlatSize* innerSize = 0, int32_t direction = 0, uint8_t bounceEnabled = 0,
                            uint8_t scrollbarEnabeld = 1, uint8_t scrollbarAutoHide = 1, float scrollbarAutoHideTime = 0.2)
    {
    ...
    inline flatbuffers::Offset<PageViewOptions>
    CreatePageViewOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> widgetOptions = 0,
                          flatbuffers::Offset<ResourceData> backGroundImageData = 0, uint8_t clipEnabled = 0, const Color* bgColor = 0,
                          const Color* bgStartColor = 0, const Color* bgEndColor = 0, int32_t colorType = 0, uint8_t bgColorOpacity = 255,
                          const ColorVector* colorVector = 0, const CapInsets* capInsets = 0, const FlatSize* scale9Size = 0, uint8_t backGroundScale9Enabled = 0)
    {
    ...
    struct ListViewOptions : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* widgetOptions */) && verifier.VerifyTable(widgetOptions()) &&
                ...
                VerifyField<FlatSize>(verifier, 24 /* scale9Size */) && VerifyField<uint8_t>(verifier, 26 /* backGroundScale9Enabled */) &&
                VerifyField<FlatSize>(verifier, 28 /* innerSize */) && VerifyField<int32_t>(verifier, 30 /* direction */) &&
                VerifyField<uint8_t>(verifier, 32 /* bounceEnabled */) && VerifyField<int32_t>(verifier, 34 /* itemMargin */) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 36 /* directionType */) && verifier.Verify(directionType()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 38 /* horizontalType */) && verifier.Verify(horizontalType()) &&
    ...
    inline flatbuffers::Offset<ListViewOptions>
    CreateListViewOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> widgetOptions = 0,
                          flatbuffers::Offset<ResourceData> backGroundImageData = 0, uint8_t clipEnabled = 0, const Color* bgColor = 0,
                          const Color* bgStartColor = 0, const Color* bgEndColor = 0, int32_t colorType = 0, uint8_t bgColorOpacity = 255,
                          const ColorVector* colorVector = 0, const CapInsets* capInsets = 0, const FlatSize* scale9Size = 0,
                          uint8_t backGroundScale9Enabled = 0, const FlatSize* innerSize = 0, int32_t direction = 0, uint8_t bounceEnabled = 0,
                          int32_t itemMargin = 0, flatbuffers::Offset<flatbuffers::String> directionType = 0,
                          flatbuffers::Offset<flatbuffers::String> horizontalType = 0, flatbuffers::Offset<flatbuffers::String> verticalType = 0)
    {
    ...
    struct ProjectNodeOptions : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* nodeOptions */) && verifier.VerifyTable(nodeOptions()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* fileName */) && verifier.Verify(fileName()) &&
                VerifyField<float>(verifier, 8 /* innerActionSpeed */) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<ProjectNodeOptions> CreateProjectNodeOptions(flatbuffers::FlatBufferBuilder& _fbb,
                                                                            ...
                                                                            flatbuffers::Offset<flatbuffers::String> fileName = 0, float innerActionSpeed = 0)
    {
    ...
    struct ComponentOptions : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* nodeOptions */) && verifier.VerifyTable(nodeOptions()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* type */) && verifier.Verify(type()) &&
    ...
    inline flatbuffers::Offset<ComponentOptions>
    CreateComponentOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> nodeOptions = 0,
                           flatbuffers::Offset<flatbuffers::String> type = 0, flatbuffers::Offset<ComAudioOptions> comAudioOptions = 0)
    {
    ...
    struct ComAudioOptions : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* nodeOptions */) && verifier.VerifyTable(nodeOptions()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* name */) && verifier.Verify(name()) && VerifyField<uint8_t>(verifier, 8 /* enabled */) &&
                VerifyField<uint8_t>(verifier, 10 /* loop */) && VerifyField<int32_t>(verifier, 12 /* volume */) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 14 /* fileNameData */) && verifier.VerifyTable(fileNameData()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<ComAudioOptions> CreateComAudioOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<WidgetOptions> nodeOptions = 0,
                                                                      flatbuffers::Offset<flatbuffers::String> name = 0, uint8_t enabled = 0, uint8_t loop = 0,
    ...
    struct AnimationInfo : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* name */) && verifier.Verify(name()) &&
                VerifyField<int32_t>(verifier, 6 /* startIndex */) && VerifyField<int32_t>(verifier, 8 /* endIndex */) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<AnimationInfo>
    CreateAnimationInfo(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<flatbuffers::String> name = 0, int32_t startIndex = 0, int32_t endIndex = 0)
    {
    ...
    struct NodeAction : private flatbuffers::Table
    {
        ...
        {
            return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<TimeLine>>*>(8);
        }
        const flatbuffers::String* currentAnimationName() const { return GetPointer<const flatbuffers::String*>(10); }
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, 4 /* duration */) && VerifyField<float>(verifier, 6 /* speed */) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* timeLines */) && verifier.Verify(timeLines()) && verifier.VerifyVectorOfTables(timeLines()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* currentAnimationName */) && verifier.Verify(currentAnimationName()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<NodeAction> CreateNodeAction(flatbuffers::FlatBufferBuilder& _fbb, int32_t duration = 0, float speed = 0,
    ...
    struct TimeLine : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* property */) && verifier.Verify(property()) &&
                VerifyField<int32_t>(verifier, 6 /* actionTag */) && VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* frames */) &&
                verifier.Verify(frames()) && verifier.VerifyVectorOfTables(frames()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<TimeLine> CreateTimeLine(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<flatbuffers::String> property = 0,
                                                        int32_t actionTag = 0, flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Frame>>> frames = 0)
    {
    ...
    struct Frame : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* pointFrame */) && verifier.VerifyTable(pointFrame()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* scaleFrame */) && verifier.VerifyTable(scaleFrame()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* colorFrame */) && verifier.VerifyTable(colorFrame()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* textureFrame */) && verifier.VerifyTable(textureFrame()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 12 /* eventFrame */) && verifier.VerifyTable(eventFrame()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 14 /* intFrame */) && verifier.VerifyTable(intFrame()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 16 /* boolFrame */) && verifier.VerifyTable(boolFrame()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 18 /* innerActionFrame */) && verifier.VerifyTable(innerActionFrame()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 20 /* blendFrame */) && verifier.VerifyTable(blendFrame()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<Frame> CreateFrame(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<PointFrame> pointFrame = 0,
                                                  flatbuffers::Offset<ScaleFrame> scaleFrame = 0, flatbuffers::Offset<ColorFrame> colorFrame = 0,
                                                  flatbuffers::Offset<TextureFrame> textureFrame = 0, flatbuffers::Offset<EventFrame> eventFrame = 0,
                                                  flatbuffers::Offset<IntFrame> intFrame = 0, flatbuffers::Offset<BoolFrame> boolFrame = 0,
    ...
    struct PointFrame : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, 4 /* frameIndex */) && VerifyField<uint8_t>(verifier, 6 /* tween */) &&
                VerifyField<Position>(verifier, 8 /* position */) && VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* easingData */) &&
    ...
    inline flatbuffers::Offset<PointFrame> CreatePointFrame(flatbuffers::FlatBufferBuilder& _fbb, int32_t frameIndex = 0, uint8_t tween = 1,
                                                            const Position* position = 0, flatbuffers::Offset<EasingData> easingData = 0)
    {
    ...
    struct ScaleFrame : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, 4 /* frameIndex */) && VerifyField<uint8_t>(verifier, 6 /* tween */) &&
                VerifyField<Scale>(verifier, 8 /* scale */) && VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* easingData */) &&
                verifier.VerifyTable(easingData()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<ScaleFrame> CreateScaleFrame(flatbuffers::FlatBufferBuilder& _fbb, int32_t frameIndex = 0, uint8_t tween = 1,
                                                            const Scale* scale = 0, flatbuffers::Offset<EasingData> easingData = 0)
    {
    ...
    struct ColorFrame : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, 4 /* frameIndex */) && VerifyField<uint8_t>(verifier, 6 /* tween */) &&
                VerifyField<Color>(verifier, 8 /* color */) && VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* easingData */) &&
                verifier.VerifyTable(easingData()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<ColorFrame> CreateColorFrame(flatbuffers::FlatBufferBuilder& _fbb, int32_t frameIndex = 0, uint8_t tween = 1,
                                                            const Color* color = 0, flatbuffers::Offset<EasingData> easingData = 0)
    {
    ...
    struct TextureFrame : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, 4 /* frameIndex */) && VerifyField<uint8_t>(verifier, 6 /* tween */) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* textureFile */) && verifier.VerifyTable(textureFile()) &&
    ...
    inline flatbuffers::Offset<TextureFrame> CreateTextureFrame(flatbuffers::FlatBufferBuilder& _fbb, int32_t frameIndex = 0, uint8_t tween = 1,
                                                                flatbuffers::Offset<ResourceData> textureFile = 0, flatbuffers::Offset<EasingData> easingData = 0)
    {
    ...
    struct EventFrame : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, 4 /* frameIndex */) && VerifyField<uint8_t>(verifier, 6 /* tween */) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* value */) && verifier.Verify(value()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* easingData */) && verifier.VerifyTable(easingData()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<EventFrame> CreateEventFrame(flatbuffers::FlatBufferBuilder& _fbb, int32_t frameIndex = 0, uint8_t tween = 1,
                                                            flatbuffers::Offset<flatbuffers::String> value = 0, flatbuffers::Offset<EasingData> easingData = 0)
    {
    ...
    struct IntFrame : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, 4 /* frameIndex */) && VerifyField<uint8_t>(verifier, 6 /* tween */) &&
                VerifyField<int32_t>(verifier, 8 /* value */) && VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* easingData */) &&
                verifier.VerifyTable(easingData()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<IntFrame> CreateIntFrame(flatbuffers::FlatBufferBuilder& _fbb, int32_t frameIndex = 0, uint8_t tween = 1, int32_t value = 0,
    ...
    struct BoolFrame : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, 4 /* frameIndex */) && VerifyField<uint8_t>(verifier, 6 /* tween */) &&
                VerifyField<uint8_t>(verifier, 8 /* value */) && VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* easingData */) &&
                verifier.VerifyTable(easingData()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<BoolFrame> CreateBoolFrame(flatbuffers::FlatBufferBuilder& _fbb, int32_t frameIndex = 0, uint8_t tween = 1, uint8_t value = 1,
                                                          flatbuffers::Offset<EasingData> easingData = 0)
    {
    ...
    struct InnerActionFrame : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, 4 /* frameIndex */) && VerifyField<uint8_t>(verifier, 6 /* tween */) &&
                VerifyField<int32_t>(verifier, 8 /* innerActionType */) && VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* currentAniamtionName */) &&
                verifier.Verify(currentAniamtionName()) && VerifyField<int32_t>(verifier, 12 /* singleFrameIndex */) &&
    ...
    inline flatbuffers::Offset<InnerActionFrame> CreateInnerActionFrame(flatbuffers::FlatBufferBuilder& _fbb, int32_t frameIndex = 0, uint8_t tween = 1,
    ...
    struct EasingData : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, 4 /* type */) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* points */) && verifier.Verify(points()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<EasingData>
    CreateEasingData(flatbuffers::FlatBufferBuilder& _fbb, int32_t type = -1, flatbuffers::Offset<flatbuffers::Vector<const Position*>> points = 0)
    {
    ...
    struct ResourceData : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* path */) && verifier.Verify(path()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* plistFile */) && verifier.Verify(plistFile()) &&
    ...
    inline flatbuffers::Offset<ResourceData> CreateResourceData(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<flatbuffers::String> path = 0,
                                                                flatbuffers::Offset<flatbuffers::String> plistFile = 0, int32_t resourceType = 0)
    {
    ...
    struct BlendFrame : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, 4 /* frameIndex */) && VerifyField<uint8_t>(verifier, 6 /* tween */) &&
                VerifyField<BlendFunc>(verifier, 8 /* blendFunc */) && VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* easingData */) &&
                verifier.VerifyTable(easingData()) && verifier.EndTable();
        }
    };
    ...
    inline flatbuffers::Offset<BlendFrame> CreateBlendFrame(flatbuffers::FlatBufferBuilder& _fbb, int32_t frameIndex = 0, uint8_t tween = 1,
                                                            const BlendFunc* blendFunc = 0, flatbuffers::Offset<EasingData> easingData = 0)
    {
