...
namespace flatbuffers
{
    ...
    struct Node3DOption : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* nodeOptions */) && verifier.VerifyTable(nodeOptions()) &&
                VerifyField<Vector3>(verifier, 6 /* position3D */) && VerifyField<Vector3>(verifier, 8 /* rotation3D */) &&
                VerifyField<Vector3>(verifier, 10 /* scale3D */) && VerifyField<int32_t>(verifier, 12 /* cameramask */) && verifier.EndTable();
        }
    };
    ...
    struct Node3DOptionBuilder
    {
        ...
        Node3DOptionBuilder(flatbuffers::FlatBufferBuilder& _fbb)
        : fbb_(_fbb)
        {
    ...
    inline flatbuffers::Offset<Node3DOption> CreateNode3DOption(flatbuffers::FlatBufferBuilder& _fbb,
                                                                flatbuffers::Offset<flatbuffers::WidgetOptions> nodeOptions = 0, const Vector3* position3D = 0,
                                                                const Vector3* rotation3D = 0, const Vector3* scale3D = 0, int32_t cameramask = 0)
    {
    ...
    struct Sprite3DOptions : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* node3DOption */) && verifier.VerifyTable(node3DOption()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* fileData */) && verifier.VerifyTable(fileData()) &&
                VerifyField<uint8_t>(verifier, 8 /* runAction */) && VerifyField<uint8_t>(verifier, 10 /* isFlipped */) &&
                VerifyField<int32_t>(verifier, 12 /* lightFlag */) && verifier.EndTable();
        }
    };
    ...
    struct Sprite3DOptionsBuilder
    {
        ...
        Sprite3DOptionsBuilder(flatbuffers::FlatBufferBuilder& _fbb)
        : fbb_(_fbb)
        {
            start_ = fbb_.StartTable();
        }
    ...
    inline flatbuffers::Offset<Sprite3DOptions> CreateSprite3DOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<Node3DOption> node3DOption = 0,
                                                                      flatbuffers::Offset<flatbuffers::ResourceData> fileData = 0, uint8_t runAction = 0,
    ...
    struct Particle3DOptions : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* node3DOption */) && verifier.VerifyTable(node3DOption()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* fileData */) && verifier.VerifyTable(fileData()) && verifier.EndTable();
        }
    };
    ...
    struct Particle3DOptionsBuilder
    {
        ...
        void add_node3DOption(flatbuffers::Offset<Node3DOption> node3DOption) { fbb_.AddOffset(4, node3DOption); }
        void add_fileData(flatbuffers::Offset<flatbuffers::ResourceData> fileData) { fbb_.AddOffset(6, fileData); }
        Particle3DOptionsBuilder(flatbuffers::FlatBufferBuilder& _fbb)
        : fbb_(_fbb)
        {
            start_ = fbb_.StartTable();
        }
    ...
    inline flatbuffers::Offset<Particle3DOptions> CreateParticle3DOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<Node3DOption> node3DOption = 0,
    ...
    struct UserCameraOptions : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* node3DOption */) && verifier.VerifyTable(node3DOption()) &&
                VerifyField<float>(verifier, 6 /* fov */) && VerifyField<float>(verifier, 8 /* nearClip */) && VerifyField<float>(verifier, 10 /* farClip */) &&
                VerifyField<int32_t>(verifier, 12 /* cameraFlag */) && VerifyField<uint8_t>(verifier, 14 /* skyBoxEnabled */) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 16 /* leftFileData */) && verifier.VerifyTable(leftFileData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 18 /* rightFileData */) && verifier.VerifyTable(rightFileData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 20 /* upFileData */) && verifier.VerifyTable(upFileData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 22 /* downFileData */) && verifier.VerifyTable(downFileData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 24 /* forwardFileData */) && verifier.VerifyTable(forwardFileData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 26 /* backFileData */) && verifier.VerifyTable(backFileData()) && verifier.EndTable();
        }
    };
    ...
    struct UserCameraOptionsBuilder
    {
        ...
        UserCameraOptionsBuilder(flatbuffers::FlatBufferBuilder& _fbb)
        : fbb_(_fbb)
        {
            start_ = fbb_.StartTable();
        }
    ...
    inline flatbuffers::Offset<UserCameraOptions>
    CreateUserCameraOptions(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<Node3DOption> node3DOption = 0, float fov = 60, float nearClip = 1,
                            float farClip = 1000, int32_t cameraFlag = 0, uint8_t skyBoxEnabled = 0,
    ...
    struct GameNode3DOption : private flatbuffers::Table
    {
        ...
        bool Verify(flatbuffers::Verifier& verifier) const
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* name */) && verifier.Verify(name()) &&
                VerifyField<int32_t>(verifier, 6 /* skyBoxMask */) && VerifyField<uint8_t>(verifier, 8 /* skyBoxEnabled */) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* leftFileData */) && verifier.VerifyTable(leftFileData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 12 /* rightFileData */) && verifier.VerifyTable(rightFileData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 14 /* upFileData */) && verifier.VerifyTable(upFileData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 16 /* downFileData */) && verifier.VerifyTable(downFileData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 18 /* forwardFileData */) && verifier.VerifyTable(forwardFileData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 20 /* backFileData */) && verifier.VerifyTable(backFileData()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 22 /* frameEvent */) && verifier.Verify(frameEvent()) &&
                VerifyField<flatbuffers::uoffset_t>(verifier, 24 /* customProperty */) && verifier.Verify(customProperty()) &&
    ...
    struct GameNode3DOptionBuilder
    {
        ...
        GameNode3DOptionBuilder(flatbuffers::FlatBufferBuilder& _fbb)
        : fbb_(_fbb)
        {
            start_ = fbb_.StartTable();
        }
    ...
    inline flatbuffers::Offset<GameNode3DOption>
    CreateGameNode3DOption(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<flatbuffers::String> name = 0, int32_t skyBoxMask = 0,
                           uint8_t skyBoxEnabled = 0, flatbuffers::Offset<flatbuffers::ResourceData> leftFileData = 0,
                           flatbuffers::Offset<flatbuffers::ResourceData> rightFileData = 0, flatbuffers::Offset<flatbuffers::ResourceData> upFileData = 0,
                           flatbuffers::Offset<flatbuffers::ResourceData> downFileData = 0, flatbuffers::Offset<flatbuffers::ResourceData> forwardFileData = 0,
                           flatbuffers::Offset<flatbuffers::ResourceData> backFileData = 0, flatbuffers::Offset<flatbuffers::String> frameEvent = 0,
                           flatbuffers::Offset<flatbuffers::String> customProperty = 0, uint8_t useDefaultLight = 0)
    {
    ...
    struct Light3DOption : private flatbuffers::Table
    {
        ...
        {
            return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, 4 /* node3DOption */) && verifier.VerifyTable(node3DOption()) &&
                VerifyField<uint8_t>(verifier, 6 /* enabled */) && VerifyField<int32_t>(verifier, 8 /* type */) &&
                VerifyField<int32_t>(verifier, 10 /* flag */) && VerifyField<float>(verifier, 12 /* intensity */) &&
                VerifyField<float>(verifier, 14 /* range */) && VerifyField<float>(verifier, 16 /* outerAngle */) && verifier.EndTable();
        }
    };
    ...
    struct Light3DOptionBuilder
    {
        ...
        Light3DOptionBuilder(flatbuffers::FlatBufferBuilder& _fbb)
        : fbb_(_fbb)
        {
            start_ = fbb_.StartTable();
        }
    ...
    inline flatbuffers::Offset<Light3DOption> CreateLight3DOption(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<Node3DOption> node3DOption = 0,
                                                                  uint8_t enabled = 0, int32_t type = 0, int32_t flag = 0, float intensity = 0, float range = 0,
                                                                  float outerAngle = 0)
    {
